...
import { BuyButton, Container, ContainerCategory, ContainerInfo, ContainerTplink, ContainerProducts, ProductBot, ProductMid, ProductTop } from './TplinkStyled';
...
const Tplink = () => {
  ...
  return (
    <ContainerTplink>
      ...
      <ContainerProducts>
        {
          products.filter((product) => (filters === 'All' && product.brand === 'TP-Link') || (product.type === filters && product.brand === 'TP-Link')).map((product) => (
