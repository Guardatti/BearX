...
import { BuyButton, Container, ContainerCategory, ContainerInfo, ContainerAmd, ContainerProducts, ProductBot, ProductMid, ProductTop } from './AmdStyled';
...
const Amd = () => {
  ...
  return (
    <ContainerAmd>
      ...
      <ContainerProducts>
        {
          products.filter((product) => (filters === 'All' && product.brand === 'AMD') || (product.type === filters && product.brand === 'AMD')).map((product) => (
