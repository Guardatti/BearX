...
import { BuyButton, Container, ContainerCategory, ContainerInfo, ContainerSamsung, ContainerProducts, ProductBot, ProductMid, ProductTop } from './SamsungStyled';
...
const Samsung = () => {
  ...
  return (
    <ContainerSamsung>
      ...
      <ContainerProducts>
        {
          products.filter((product) => (filters === 'All' && product.brand === 'Samsung') || (product.type === filters && product.brand === 'Samsung')).map((product) => (
