...
import { BuyButton, Container, ContainerCategory, ContainerInfo, ContainerSecretlab, ContainerProducts, ProductBot, ProductMid, ProductTop } from './SecretlabStyled';
...
const Secretlab = () => {
  ...
  return (
    <ContainerSecretlab>
      ...
      <ContainerProducts>
        {
          products.filter((product) => (filters === 'All' && product.brand === 'Secretlab') || (product.type === filters && product.brand === 'Secretlab')).map((product) => (
