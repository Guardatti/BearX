...
import { BuyButton, Container, ContainerCategory, ContainerInfo, ContainerXseries, ContainerProducts, ProductBot, ProductMid, ProductTop } from './XseriesStyled';
...
const Xseries = () => {
  ...
  return (
    <ContainerXseries>
      ...
      <ContainerProducts>
        {
          products.filter((product) => (filters === 'All' && product.brand === 'Xbox Series') || (product.type === filters && product.brand === 'Xbox Series')).map((product) => (
