...
import { BuyButton, Container, ContainerCategory, ContainerInfo, ContainerApple, ContainerProducts, ProductBot, ProductMid, ProductTop } from './AppleStyled';
...
const Apple = () => {
  ...
  return (
    <ContainerApple>
      ...
      <ContainerProducts>
        {
          products.filter((product) => (filters === 'All' && product.brand === 'Apple') || (product.type === filters && product.brand === 'Apple')).map((product) => (
