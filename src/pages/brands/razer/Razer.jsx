...
import { BuyButton, Container, ContainerCategory, ContainerInfo, ContainerRazer, ContainerProducts, ProductBot, ProductMid, ProductTop } from './RazerStyled';
...
const Razer = () => {
  ...
  return (
    <ContainerRazer>
      ...
      <ContainerProducts>
        {
          products.filter((product) => (filters === 'All' && product.brand === 'Razer') || (product.type === filters && product.brand === 'Razer')).map((product) => (
