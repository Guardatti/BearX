...
import { BuyButton, Container, ContainerCategory, ContainerInfo, ContainerCorsair, ContainerProducts, ProductBot, ProductMid, ProductTop } from './CorsairStyled';
...
const Corsair = () => {
  ...
  return (
    <ContainerCorsair>
      ...
      <ContainerProducts>
        {
          products.filter((product) => (filters === 'All' && product.brand === 'Corsair') || (product.type === filters && product.brand === 'Corsair')).map((product) => (
