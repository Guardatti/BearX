...
import { BuyButton, Container, ContainerCategory, ContainerInfo, ContainerPrimus, ContainerProducts, ProductBot, ProductMid, ProductTop } from './PrimusStyled';
...
const Primus = () => {
  ...
  return (
    <ContainerPrimus>
      ...
      <ContainerProducts>
        {
          products.filter((product) => (filters === 'All' && product.brand === 'Primus') || (product.type === filters && product.brand === 'Primus')).map((product) => (
