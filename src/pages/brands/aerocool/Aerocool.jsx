...
import { BuyButton, Container, ContainerCategory, ContainerInfo, ContainerAerocool, ContainerProducts, ProductBot, ProductMid, ProductTop } from './AerocoolStyled';
...
const Aerocool = () => {
  ...
  return (
    <ContainerAerocool>
      ...
      <ContainerProducts>
        {
          products.filter((product) => (filters === 'All' && product.brand === 'Aerocool') || (product.type === filters && product.brand === 'Aerocool')).map((product) => (
