...
import { BuyButton, Container, ContainerCategory, ContainerInfo, ContainerKingston, ContainerProducts, ProductBot, ProductMid, ProductTop } from './KingstonStyled';
...
const Kingston = () => {
  ...
  return (
    <ContainerKingston>
      ...
      <ContainerProducts>
        {
          products.filter((product) => (filters === 'All' && product.brand === 'Kingston') || (product.type === filters && product.brand === 'Kingston')).map((product) => (
